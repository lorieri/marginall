## Como montar um Marginall

**ATENÇÃO: ESSE MANUAL É PARA ADULTOS COM CONHECIMENTO DE ELÉTRICA, PODE DAR CHOQUES FATAIS**

Esse manual é genérico, pode usar ser usado para criar um Marginall para baixo ou para guitarra, e de qualquer tamanho.

Para entender melhor sobre o projeto e para que serve cada pedaço dele, leia o [artigo que conta a história do Marginall](https://medium.com/@leolorieri/bandas-underground-mais-watts-por-menos-grana-ecbaea003667).

### Ingredientes

 - 1 gabinete para colocar os alto-falantes
 - alto-falantes - podem ser quantos você quiser, recomendo quatro de 8 ohms, de guitarra ou contrabaixo
 - 1 pedal com controle de volume - recomendo: equalizer ou pré-amp, para contrabaixo ou para guitarra
 ...
 - 1 tomada com fio
 - 1 fonte 12 volts, de no mínimo 30 amperes - veja no manual do módulo o consumo
 - 3 cabos "Y" RCA, geralmente vêm 2 junto com o módulo
 
 Se você não for ligar os canais diretamente nos alto-falantes, como é feito no Marginall Versão Dois - Flex:
...
A soma dos Watts dos alto-falantes deve ser maior que a potência em Watts do canal do módulo a utilizar, para não estourá-los.
...
Recomendo utilizar canais de no mínimo 4 ohms, ao que parece, observando amplificadores, a quantidade de ohms pode significar qualidade de som.

Recomendo escolher os alto-falantes primeiro, e com base neles escolher o módulo.

Recomendo utilizar alto-falantes de guitarra e contrabaixo, a [ELD Power](https://www.facebook.com/eldpowerloudspeakers/) faz alto-falantes customizados com preços acessíveis.

No Marginall Versão Um utilizei 4 alto-falantes iguais de 150 Watts e 8 ohms, 2 para cada canal. Ligando 2 alto-falantes em paralelo temos 300 Watts e 4 ohms (como descrito no link acima). Então escolhi [um módulo](http://hurricane.com.br/produto/h-400-4d/) que tinha 4 canais de 60 Watts em 4 ohms, mas que ligados em modo "bridged" ficava com 2 canais de 200 Watts e 4 ohms.
